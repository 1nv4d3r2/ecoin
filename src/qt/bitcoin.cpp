...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Ecoin");
    QApplication::setOrganizationDomain("ecoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Ecoin-Qt-testnet");
    else
        QApplication::setApplicationName("Ecoin-Qt");
